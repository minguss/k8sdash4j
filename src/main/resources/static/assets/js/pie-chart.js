...
if ($('#daemonset_chart').length) {
    AmCharts.makeChart("daemonset_chart", {
        "type": "pie",
        "theme": "light",
        "labelRadius": -45,
        "labelText": "[[percents]]%",
...
if ($('#ampiechart33').length) {
    AmCharts.makeChart("ampiechart33", {
        "type": "pie",
        "theme": "light",
        "labelRadius": -45,
        "labelText": "[[percents]]%",
...
if ($('#ampiechart34').length) {
    AmCharts.makeChart("ampiechart34", {
        "type": "pie",
        "theme": "light",
        "labelRadius": -45,
        "labelText": "[[percents]]%",
